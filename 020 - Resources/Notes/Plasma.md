...
- 90% water
- 6-7% proteins
	- [[Albumin]] - causes [[Plasma colloid osmotic pressure]]
	- [[Globulin]] 
	- [[Fibrinogen]]
- 3% other
	- Fats
...
![](https://i.imgur.com/LIpXwoM.png)

# Reasons for plasma level changes
~
Plasma levels change due to other factors
» Dehydration– can mask anaemia
» Increased fluid in pregnancy– can mimicanaemia


# Laboratory Analysis
~
in sum: refractometers, protein electrophoresis, electrodes, biochemistry, glucometer
Protein
• Total protein– refractometer or biochemistry
• Albumin– biochemistry or protein electrophoresis
Electrolytes
• Na, K, Cl, HCO3– ion specific electrode or biochemical method
